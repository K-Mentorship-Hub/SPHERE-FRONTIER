const SPHERES={
  S:{name:"Science",icon:"\u{1FA7A}",color:"var(--science)",
    bachelor:["Biology","Chemistry","Physics","Math","English"],
    master:["Molecular Biology","Biochemistry","Biophysics","Statistics","English"]},
  E:{name:"Entrepreneurship",icon:"\u{1F680}",color:"var(--entrepreneurship)",
